...
def run(argv=None, save_main_session=True):  
    ...
    with beam.Pipeline(options=PipelineOptions(pipeline_args)) as p:
        ...
        output | 'WriteToText' >> beam.io.WriteToText(known_args.output)#'gs://temp_data_exam/output_folder/output', file_name_suffix='.csv',num_shards=1,header='year,number,name')
